...
const credentialAuth = {
  ...
  "private_key_id": process.env.FIREBASE_AD_PRIVATE_KEY_ID,
  "private_key": process.env.FIREBASE_AD_PRIVATE_KEY,
  "client_email": process.env.FIREBAE_AD_CLIENT_EMAIL,
  "client_id": process.env.FIREBASE_AD_CLIENT_ID,
